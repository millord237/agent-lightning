...
class AgentLightningServer:
    ...
    def __init__(self, host: str = "127.0.0.1", port: int = 8000, task_timeout_seconds: float = 360.0):
        ...
        self._uvicorn_config = uvicorn.Config(self._app, host=self.host, port=self.port, log_level="error")
