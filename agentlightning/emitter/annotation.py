...
from agentlightning.semconv import AGL_ANNOTATION, LightningSpanAttributes
from agentlightning.types import SpanLike, SpanNames

from .utils import flatten_attributes, get_tracer

logger = logging.getLogger(__name__)


def emit_annotation(annotation: Dict[str, Any]) -> ReadableSpan:
