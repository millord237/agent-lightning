...
async def debug():
    ...
    resource = agl.LLM(
        endpoint="http://127.0.0.1:8032/v1", model="/cfs_turbo/beauzbhe/retool/verl/checkpoint/multiturn-sft-qwen-2.5-7b-instruct/global_step_372_merge", sampling_parameters={"temperature": 0}
    )
